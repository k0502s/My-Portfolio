...
import test from './images/mockup.png';
                ...
                <S.SubWrap>
                    <ul>
                        ...
                        <li>
                            ...
                            <span>사용된 기술</span>
                            <br />
                            Client <b>React.js, Styled-Components</b>
                            <br />
                            Devops <b>Git</b>
                            <S.BtnWrap>
                    ...
                    <ul>
                        ...
                        <li>
                            <h3>사진 동호회 웹 사이트</h3>
                            <br />
                            실제 동호회 모임을 넷상에서도 정보와 친목을 공유할 수 있게끔 CRUD 중심의 SPA 사이트를 제작하였습니다. 회원들이 직접 찍은 포토들을 갤러리에서 공유할 수 있고, 게시판에서
                            ...
                            <span>사용된 기술</span>
                            <br />
                            Client <b>React.js, Redux Saga, Reactsrap, Styled-Components</b>
                            <br />
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <br />
                            또 실제로 동호회 사이트에서 챗봇으로 통해 들어온 문의사항 데이터들을 받아내어 view로 보여주고 이메일 전송 API을 통해 바로 문의사항의 답변을 보낼 수 있도록 하였고 다음 모임
